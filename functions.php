...
function add_script() {
  ...
  wp_enqueue_script('theme-main-js', $theme_uri . '/asset/js/main.js', array('jquery','progressbar','gsap-min','gsap-scrollToPlugin','gsap-scrollTrigger','slick-js'),'1.0.2', true, 'all');
}
